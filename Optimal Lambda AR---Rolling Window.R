...
StoragePath = "C:/Users/581/Documents/Optimal LASSO Networks/Continent.Weight."
...
Density = read.csv(
  file = "NewFigure-Roll.Window_Desity.csv", header = FALSE
)
Density = as.matrix(Density)


Phase.Num = nrow(Density)
Dates_labels = as.character(2001:2022)
Dates_breaks = c(seq(from=1, to=365, by=52), seq(from=418, to=626, by=52),
                 seq(from=679, to=939, by=52), seq(from=992, to=1096, by=52))
Dates_labels = as.character(seq(from=2002, to=2022, by=2))
Dates_breaks = c(53, 157, 261, 365, 470, 574, 679, 783, 887, 992, 1096) # -5
# Dates_breaks = c(12, 64, 116, 168, 220, 272, 324, 377, 429, 481,
#                  533, 585, 638, 690, 742, 794, 846, 898, 951, 1003,
#                  1055, 1104)
...
Fig_Density = (
  BFig_Density + geom_line(linetype = "solid", linewidth = 1) #+ guides(color = "none")
  + scale_color_manual(values = c("black", "red", "blue"))
  + scale_x_continuous(breaks = Dates_breaks, labels = Dates_labels)
...
ggsave(filename = "NewFig_Density.eps", device = cairo_ps, dpi = 300,
       width = 25, height = 15, units = "cm",
       path = "D:/Research/2019  Financial Risk Networks by LASSO/New Data")
ggsave(filename = "NewFig_Density.tiff", device = "tiff", dpi = 300,
       width = 25, height = 15, units = "cm",
       path = "D:/Research/2019  Financial Risk Networks by LASSO/New Data")
ggsave(filename = "NewFig_Density.png", device = "png", dpi = 300,
       width = 25, height = 15, units = "cm",
       path = "D:/Research/2019  Financial Risk Networks by LASSO/New Data")
...
##=====================================================================================##
##=====================================================================================##
##               Import Figure Data for Continent Weights                              ##
##=====================================================================================##
##=====================================================================================##
##=====================================================================================##
...
# Input Data
setwd("C:/Users/581/Documents/Optimal LASSO Networks")
Continent.Weight_U = read.csv(
  file = "NewFigure-Roll.Window_Continent.Weight_Unsigned.csv", header = FALSE
)
Continent.Weight_U = as.matrix(Continent.Weight_U)

Continent.Weight_P = read.csv(
  file = "NewFigure-Roll.Window_Continent.Weight_Positive.csv", header = FALSE
)
Continent.Weight_P = as.matrix(Continent.Weight_P)

Continent.Weight_N = read.csv(
  file = "NewFigure-Roll.Window_Continent.Weight_Negative.csv", header = FALSE
)
Continent.Weight_N = as.matrix(Continent.Weight_N)


Phase.Num = nrow(Continent.Weight_U)
...
##=====================================================================================##
##=====================================================================================##
##               Figure for Continent Weights by For Loop (3*3 Format)                 ##
##=====================================================================================##
##=====================================================================================##
##=====================================================================================##
...
Fig_Cont.Strength = (
  BFig_Cont.Strength + geom_line(linetype = "solid", linewidth = 1)
...
Fig_Cont.Strength_P = (
  BFig_Cont.Strength_P + geom_line(color = "red", linetype = "solid", linewidth = 1)
  #+ guides(color = "none")
  + ylim(0, 16)
  # + scale_x_continuous(breaks = round(nrow(Density)/40*c(2.5,13,23,34.5)),
  #                      labels = c("2006", "2007", "2008", "2009"))
...
Fig_Cont.Strength_N = (
  BFig_Cont.Strength_N + geom_line(color = "blue", linetype = "solid", linewidth = 1)
  #+ guides(color = "none") + ylim(0, 20)
  # + scale_x_continuous(breaks = round(nrow(Density)/40*c(2.5,13,23,34.5)),
  #                      labels = c("2006", "2007", "2008", "2009"))
...
Fig_Cont.Strength_P = (
  BFig_Cont.Strength_P + geom_line(color = "red", linetype = "solid", linewidth = 1.5)
  + ylim(0, 10) + theme(text = element_text(size=text.size))   # change font size of all text
  + scale_x_continuous(breaks = Dates_breaks, labels = Dates_labels)
  + labs(x = "Date", y = "Positive Strength", title = Cont.Name_Fig(ii, jj))
)
print(Fig_Cont.Strength_P, vp = vplayout(ii, jj))
...
Fig_Cont.Strength_P = (
  BFig_Cont.Strength_P + geom_line(color = "red", linetype = "solid", linewidth = 1.5)
  + ylim(0, 23) + theme(text = element_text(size=text.size))
  + scale_x_continuous(breaks = Dates_breaks, labels = Dates_labels)
  + labs(x = "Date", y = "Positive Strength", title = Cont.Name_Fig(ii, jj))
)
print(Fig_Cont.Strength_P, vp = vplayout(ii, jj))
...
Fig_Cont.Strength_P = (
  BFig_Cont.Strength_P + geom_line(color = "red", linetype = "solid", linewidth = 1.5)
  + ylim(0, 10) + theme(text = element_text(size=text.size))
  + scale_x_continuous(breaks = Dates_breaks, labels = Dates_labels)
  + labs(x = "Date", y = "Positive Strength", title = Cont.Name_Fig(ii, jj))
)
print(Fig_Cont.Strength_P, vp = vplayout(ii, jj))
...
ggsave(filename = "NewFig_Strength_Positive.eps", device = cairo_ps, dpi = 300,
       width = 25, height = 15, units = "cm",
       path = "D:/Research/2019  Financial Risk Networks by LASSO/New Data")
ggsave(filename = "NewFig_Strength_Positive.png", device = "png", dpi = 300,
       width = 25, height = 15, units = "cm",
       path = "D:/Research/2019  Financial Risk Networks by LASSO/New Data")
ggsave(filename = "NewFig_Strength_Positive.tiff", device = "tiff", dpi = 300,
       width = 25, height = 15, units = "cm",
       path = "D:/Research/2019  Financial Risk Networks by LASSO/New Data")
...
Fig_Cont.Strength_N = (
  BFig_Cont.Strength_N + geom_line(color = "blue", linetype = "solid", linewidth = 1.5)
  + ylim(0, 6) + theme(text = element_text(size=text.size))
  + scale_x_continuous(breaks = Dates_breaks, labels = Dates_labels)
  + labs(x = "Date", y = "Negative Strength", title = Cont.Name_Fig(ii, jj))
)
print(Fig_Cont.Strength_N, vp = vplayout(ii, jj))
...
Fig_Cont.Strength_N = (
  BFig_Cont.Strength_N + geom_line(color = "blue", linetype = "solid", linewidth = 1.5)
  + ylim(0, 26) + theme(text = element_text(size=text.size))
  + scale_x_continuous(breaks = Dates_breaks, labels = Dates_labels)
  + labs(x = "Date", y = "Negative Strength", title = Cont.Name_Fig(ii, jj))
)
print(Fig_Cont.Strength_N, vp = vplayout(ii, jj))
...
ggsave(filename = "NewFig_Strength_Negative.eps", device = cairo_ps, dpi = 300,
       width = 25, height = 15, units = "cm",
       path = "D:/Research/2019  Financial Risk Networks by LASSO/New Data")
ggsave(filename = "NewFig_Strength_Negative.png", device = "png", dpi = 300,
       width = 25, height = 15, units = "cm",
       path = "D:/Research/2019  Financial Risk Networks by LASSO/New Data")
ggsave(filename = "NewFig_Strength_Negative.tiff", device = "tiff", dpi = 300,
       width = 25, height = 15, units = "cm",
       path = "D:/Research/2019  Financial Risk Networks by LASSO/New Data")
